/**
 * FILE: PollCard.tsx
 * PATH: /src/components/PollCard.tsx
 * DESCRIPTION: 
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-6 right-6 z-20">
        <span className={`px-4 py-1.5 rounded-full text-[8px] font-black uppercase tracking-[0.2em] shadow-sm transition-colors duration-500 ${
          isAnswered 
      ...
      <div className="p-8 flex-1">
        ...
        <div className="flex items-center space-x-4 mb-8">
          <div className="relative">
            <img
              ...
              alt={author.name}
              className="w-12 h-12 rounded-2xl bg-slate-100 object-cover ring-4 ring-slate-50 group-hover:rotate-3 transition-transform duration-500"
        ...
        <h4 className="text-xl font-black text-slate-900 italic tracking-tighter leading-[1.1] mb-6">
          Would You <br/>
        ...
        <div className="space-y-3">
          <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 group-hover:bg-indigo-50/50 group-hover:border-indigo-100 transition-colors duration-500">
      ...
      <div className={`px-8 py-5 flex items-center justify-between transition-all duration-500 ${
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white transform group-hover:translate-x-1 transition-transform duration-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
